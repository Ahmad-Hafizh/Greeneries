...
export default function SignInPage() {
  return (
    <div className="flex flex-col-reverse lg:grid lg:min-h-svh lg:grid-cols-2">
      <div className="absolute bottom-0 z-10 bg-white w-full lg:relative rounded-t-3xl overflow-hidden lg:rounded-none flex flex-col gap-4 p-6 pt-10 lg:pt-6 md:p-10 h-fit lg:h-full">
